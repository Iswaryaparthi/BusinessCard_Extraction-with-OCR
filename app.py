    ...
    # --------------------------------------   /   Data Upload to Mysql   /   --------------------------------------- #
        ...
        if session_state.data_uploaded:
            ...
            try:
                ...
                data_df.to_sql('card_data', connect, if_exists='append', index=False, dtype={
    ...
    with col1:
        ...
        try:
            ...
            if session_state.data_update:
                ...
                cursor.execute(
                    "UPDATE card_data SET Company_name = %s, Designation = %s, Mobile_number = %s, Email = %s, "
    ...
    with col2:
        ...
        try:
            ...
            if session_state.data_delet:
                cursor.execute(f"DELETE FROM card_data WHERE Card_holder='{delete_name}'")
                conn_del.commit()
